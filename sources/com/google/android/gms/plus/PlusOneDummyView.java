...
public class PlusOneDummyView extends FrameLayout {
    ...
    private static class C1111a implements C1114d {
    ...
    private static class C1112b implements C1114d {
        private Context mContext;

        private C1112b(Context context) {
            this.mContext = context;
        }
    ...
    private static class C1113c implements C1114d {
        private Context mContext;

        private C1113c(Context context) {
            this.mContext = context;
        }
    ...
    public PlusOneDummyView(Context context, int size) {
        ...
        button.setBackgroundDrawable(m3259eN().getDrawable(size));
        Point bi = m3258bi(size);
        addView(button, new LayoutParams(bi.x, bi.y, 17));
    }

    /* renamed from: bi */
    private Point m3258bi(int i) {
        int i2 = 24;
        int i3 = 20;
    ...
    /* renamed from: eN */
    private C1114d m3259eN() {
        C1114d bVar = new C1112b(getContext());
        if (!bVar.isValid()) {
            bVar = new C1113c(getContext());
        }
        return !bVar.isValid() ? new C1111a(getContext()) : bVar;
    }
}
