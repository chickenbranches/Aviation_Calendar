...
import com.google.android.gms.internal.C0567du;
import com.google.android.gms.internal.C0584dz;
...
public final class GooglePlayServicesUtil {
    ...
    /* renamed from: a */
    public static Dialog m165a(int i, Activity activity, int i2, OnCancelListener onCancelListener, int i3) {
        Builder message = new Builder(activity).setMessage(m171b(activity, i, i3));
        if (onCancelListener != null) {
            message.setOnCancelListener(onCancelListener);
        }
        C0567du duVar = new C0567du(activity, m166a(activity, i, i3), i2);
        String b = m170b(activity, i);
        if (b != null) {
    ...
    /* renamed from: a */
    public static Intent m166a(Context context, int i, int i2) {
        switch (i) {
            case 1:
            case 2:
                return m177y(i2) ? m176o(context) ? C0584dz.m1474T(GOOGLE_PLAY_SERVICES_PACKAGE) : C0584dz.m1473S("com.google.android.apps.bazaar") : C0584dz.m1473S(GOOGLE_PLAY_SERVICES_PACKAGE);
            case 3:
                return C0584dz.m1471Q(GOOGLE_PLAY_SERVICES_PACKAGE);
            case 12:
                return C0584dz.m1475bX();
            default:
                return null;
        }
    }
    ...
    /* renamed from: a */
    public static boolean m167a(Resources resources) {
        if (resources == null) {
            return false;
        }
        return (C0633fg.m1703cD() && ((resources.getConfiguration().screenLayout & 15) > 3)) || m172b(resources);
    }

    /* renamed from: a */
    private static byte[] m168a(PackageInfo packageInfo, byte[]... bArr) {
        try {
    ...
    /* renamed from: a */
    private static byte[][] m169a(byte[][]... bArr) {
        int i = 0;
    ...
    /* renamed from: b */
    public static String m170b(Context context, int i) {
    ...
    /* renamed from: b */
    public static String m171b(Context context, int i, int i2) {
        Resources resources = context.getResources();
        switch (i) {
            case 1:
                String string = m167a(context.getResources()) ? resources.getString(C0083R.string.common_google_play_services_install_text_tablet) : resources.getString(C0083R.string.common_google_play_services_install_text_phone);
                return m177y(i2) ? string + " (via Bazaar)" : string;
            case 2:
                String string2 = resources.getString(C0083R.string.common_google_play_services_update_text);
                return m177y(i2) ? string2 + " (via Bazaar)" : string2;
            case 3:
    ...
    /* renamed from: b */
    private static boolean m172b(Resources resources) {
        Configuration configuration = resources.getConfiguration();
        return C0633fg.m1705cF() && (configuration.screenLayout & 15) <= 3 && configuration.smallestScreenWidthDp >= 600;
    }

    /* renamed from: bi */
    public static boolean m173bi() {
        return f243mK ? f244mL : "user".equals(Build.TYPE);
    }

    public static Dialog getErrorDialog(int errorCode, Activity activity, int requestCode) {
        return m165a(errorCode, activity, requestCode, null, -1);
    }

    public static Dialog getErrorDialog(int errorCode, Activity activity, int requestCode, OnCancelListener cancelListener) {
        return m165a(errorCode, activity, requestCode, cancelListener, -1);
    }

    public static PendingIntent getErrorPendingIntent(int errorCode, Context context, int requestCode) {
        Intent a = m166a(context, errorCode, -1);
        if (a == null) {
            return null;
        }
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        m175n(context);
        try {
            byte[] a = m168a(packageManager.getPackageInfo(GOOGLE_PLAY_STORE_PACKAGE, 64), f236mD);
            if (a == null) {
    ...
    /* renamed from: m */
    public static void m174m(Context context) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException {
        int isGooglePlayServicesAvailable = isGooglePlayServicesAvailable(context);
        if (isGooglePlayServicesAvailable != 0) {
            Intent a = m166a(context, isGooglePlayServicesAvailable, -1);
    ...
    /* renamed from: n */
    private static void m175n(Context context) {
    ...
    /* renamed from: o */
    private static boolean m176o(Context context) {
        if (f243mK) {
            return f245mM;
        }
        try {
            return m168a(context.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), f242mJ) != null;
        } catch (NameNotFoundException e) {
            return false;
        }
    }
    ...
    /* renamed from: z */
    private static int m178z(int i) {
        if (i == -1) {
            return 2;
        }
        return i;
